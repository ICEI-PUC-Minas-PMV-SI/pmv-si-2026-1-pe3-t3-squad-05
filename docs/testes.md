...
O relatório não apresenta resultados inventados. A etapa de observação somente poderá ser considerada concluída depois que cada integrante aplicar sua tarefa com um usuário distinto e preencher a seção correspondente no DOCX.

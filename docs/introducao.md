...
Desenvolver um sistema digital para gestão de encomendas em panificadoras e confeitarias, integrado a um aplicativo de pedidos, que permita aos clientes realizar reservas e encomendas de produtos. O sistema também deverá auxiliar o estabelecimento no controle de pedidos e na gestão de estoque, considerando de forma integrada as vendas realizadas presencialmente e as efetuadas online.
Analisar o funcionamento atual dos processos de encomenda e venda em panificadoras e confeitarias, identificando limitações relacionadas ao controle de pedidos e ao gerenciamento de estoque.
Projetar um sistema que possibilite aos clientes realizar pedidos e encomendas de produtos de forma online, com opções de retirada no estabelecimento ou entrega.
Implementar funcionalidades que permitam ao cliente acompanhar o status do pedido, desde a confirmação até a entrega ou retirada.
Criar recursos que facilitem a comunicação entre cliente e estabelecimento em situações como indisponibilidade de produtos ou necessidade de alterações no pedido.

## 1.3. Justificativa

A criação deste sistema surge da necessidade de modernizar e profissionalizar a operação de padarias e confeitarias, setores que lidam diariamente com insumos de alta perecibilidade e fluxo de pedidos personalizados que exigem excelência operacional.
A principal motivação reside na eliminação de falhas humanas comuns no modelo tradicional com o uso de cadernos e planilhas. E, além disso, mitigar o esquecimento de detalhes em encomendas da panificadora e confeitaria, ou a falta de ingredientes críticos no momento da produção e venda. Dessa forma, reduz o desperdício, aumenta a lucratividade e garante a consolidação de boa reputação no negócio.
